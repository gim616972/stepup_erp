            ...
            <div class="col-12 offset-0">
                <div class="card border-0">
                    <div class="card-body p-0">
                        <?php
                        $stmt = $conn->prepare("SELECT * FROM tbl_orders WHERE member_id = :member_id ORDER BY id DESC");
                        ...
                        <div class="table-responsive shadow rounded" style="max-height: 60vh;">
                            <table class="table mb-0">
                                <tr id="heading_tr">
                                    ...
                                    <th class="t_head">Delivery Partner</th>
                                    <th>Delivery Fee</th>
                                </tr>
                                    <?php
                                        ...
                                        <tr id="body_tr">
                                            ...
                                            <td>
                                                <div class="d-grid small_text">
                                                    ...
                                                    <?php
                                                    if ($orders['status'] == 1) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">On Hold </span>'.$orders['date_action'].'</p>';
                                                    } else if ($orders['status'] == 2) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">Approved </span>'.$orders['date_action'].'</p>';
                                                    } else if ($orders['status'] == 3) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">Processing </span>'.$orders['date_action'].'</p>';
                                                    } else if ($orders['status'] == 4) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">Shipped </span>'.$orders['date_action'].'</p>';
                                                    } else if ($orders['status'] == 5) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">In-Transit </span>'.$orders['date_action'].'</p>';
                                                    } else if ($orders['status'] == 6) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">Delivered </span>'.$orders['date_action'].'</p>';
                                                    } else if ($orders['status'] == 7) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">Flagged </span>'.$orders['date_action'].'</p>';
                                                    } else if ($orders['status'] == 8) {
                                                        echo '<p class="mb-1"><span style="font-weight: 500;">Cancelled </span>'.$orders['date_action'].'</p>';
                                                    }
                                                    ?>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <?php
                                                $dl_partner = $orders['dl_partner'];
                                                if ($dl_partner == "Steadfast") {
                                                ?>
                                                    <p class="text-dinfo mb-2">Steadfast</p>
                                                    <p class="mb-2">Status:
                                                        <a class="p-1 border" href="https://steadfast.com.bd/t/<?php echo $orders['dl_tracking_code']; ?>" target="_blank">
                                                            <i class="fa fa-map px-2"></i><?php echo $orders['dl_tracking_code']; ?>
                                                        </a>
                                                    </p>
                                                    <p>ID: <?php echo $orders['dl_consignment']; ?></p>
                                                <?php
                                                } else {
                                                    echo "N/A";
                                                }
